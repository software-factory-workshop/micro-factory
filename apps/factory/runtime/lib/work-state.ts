...
export interface WorkState {
 sandboxStarted:boolean; prepared:boolean; revision:string; prototypeRevision:string; repository:string; prototypeRepository:string;
...
export const workState=defineState<WorkState>("factory.work",()=>({sandboxStarted:false,prepared:false,revision:"",prototypeRevision:"",repository:factoryRepository,prototypeRepository,baseline:[],commands:[],pull:null,publication:null,operationId:"",activeBrief:"",targetBranch:"main",targetHeadSha:"",mergeTarget:false,completedOperations:{},basePrepared:false,verificationFindings:[],contextGaps:[],recorded:false,verifiedDigest:null,reviewVerified:false,gate:null,attributions:[],e2eRanOnHead:false,secretScanClean:null}));
